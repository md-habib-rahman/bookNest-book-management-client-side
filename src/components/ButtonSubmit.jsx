...
const ButtonSubmit = ({ text, addClass }) => {
  return (
    <button
      type="submit"
	  
      className={`relative group inline-block px-4 py-2 m-1 border-2 font-medium border-primary bg-primary text-white text-center rounded-xl overflow-hidden btn ${addClass}`}
    >
